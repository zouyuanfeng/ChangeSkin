...
public class MenuLeftFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.id_rl_innerchange03).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.id_rl_innerchange01:
                SkinManager.getInstance().changeSkin(getActivity(), "red");
                break;
            case R.id.id_rl_innerchange02:
                SkinManager.getInstance().changeSkin(getActivity(), "green");
                break;
